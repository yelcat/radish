...
import com.radishframework.radish.springboot.annotations.RadishService;
...
@SupportedAnnotationTypes("com.radishframework.radish.springboot.annotations.RadishService")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@AutoService(Processor.class)
public class RadishServiceProcessor extends AbstractProcessor {
    @Override
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        Set<? extends Element> elements = roundEnv.getElementsAnnotatedWith(RadishService.class);
        ...
        try {
            Optional<? extends AnnotationMirror> annotationMirrorResult = classElement
                    ...
                    .filter(mirror -> mirror.getAnnotationType().toString()
                            .equals("com.radishframework.radish.springboot.annotations.RadishService"))
                    .findFirst();
