...
public class KubernetesNameResolver extends NameResolver {
    ...
    public KubernetesNameResolver(final String name, final int port,
    ...
    public void refresh() {
        ...
        try {
            ...
            final Endpoints endpoints = kubernetesClient.endpoints().withName(name).get();
            if (endpoints == null) {
    ...
    private void update(Endpoints endpoints) {
        ...
        final List<EquivalentAddressGroup> servers = endpoints.getSubsets().stream()
    ...
    protected void watch() {
        ...
        kubernetesClient.endpoints().withName(name).watch(new Watcher<Endpoints>() {
            @Override
